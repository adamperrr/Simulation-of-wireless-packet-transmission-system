...
/**
 * 
 * Class TransmissionSystem combines all 
 * of the functions and object of the system.
 * 
...
public class TransmissionSystem 
{
	 ...
	 * @param timeEvent - event to add to agenda
	 * */
	...
	/**
	 * Sets maximum simulation time in milliseconds
	 * Default time is 400.0ms
	...
	private ArrayList<Events.TimeEvent> timeEvents = new ArrayList<>(); // List of time events
	private ArrayList<Events.ConditionalEvent> conditionalEvents = new ArrayList<>(); // List of time events
	private Vector <Transmitter> transmitters = new Vector<>(NUMBER_OF_DEVICES); // Vector of transmitters.
