...
public class Transmitter implements Device
{
	 ...
	 * @param packet - packet for the Transmitter
	 * */
	...
	/**
	 * Transmission settings for this transmitter
	 * Declaration is placed here because it needs rand to work.
	 * */
	public TransmissionSettings transmissionSettings = null;
	
	private int id = -1; // Id of this device.
	private Queue<Packet> buffer = new LinkedList<>(); // Buffer of packets to send to channel.
	private Packet receivedPacket = null; // Packet received from the channel.
	private boolean isBusy = false; // Occupancy state of the device. If packet is processed. It doesn't mean packet is ready to send.
	private boolean packetReadyToSend = false; // Packet is ready to send after listening
