...
/**
 * Interface Device is the base for Receiver and Transmitter class. It contains
 * basic properties which are necessary to implement in the class.
 */
public interface Device
{
  ...
  /**
   * Packet pushed to the device from channel. For transmitter it is a ACK
   * packet sent by receiver. For receiver it is a packet sent by transmitter.
   */
