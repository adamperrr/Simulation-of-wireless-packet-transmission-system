...
/**
 * Class Receiver Sends packets to channel and waits for the response.
 */
public class Receiver implements Device
{
  ...
  private boolean readyACK = false; // Says when receiver should send a ACK
                                    // packet
