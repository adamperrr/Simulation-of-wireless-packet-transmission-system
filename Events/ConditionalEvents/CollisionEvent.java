...
public class CollisionEvent implements ConditionalEvent
{
  ...
  /**
   * Check if there are more than one packets in the channel If function returns
   * true it means there is a collision in the channel
   */
  public boolean condition()
  {
    boolean thereAreCorrectPackets = false; //
    boolean thereAreMoreThanOnePackets = (channel.getBuffer().size() > 1); // There
                                                                           // are
                                                                           // more
                                                                           // than
                                                                           // one
  ...
  /**
   * If there are more than one packets in the channel buffer function sets them
   * faulty
   */
  public void execute()
  {
